# Predictive entropy pilot (share mode, sr=1.1, seeds=20)
...
- pooled corr(safe, Var(H_pred)) across all grouped points: `0.224`
...
![raw_points_safe_vs_w_align](figs/raw_points_safe_vs_w_align.png)

![raw_points_pred_entropy_var_vs_w_align](figs/raw_points_pred_entropy_var_vs_w_align.png)
