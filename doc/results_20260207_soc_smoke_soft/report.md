# SOC smoke soft (sr=1.1, steps=400, seeds=20)
...
- Sweep directory: `runs/sweep_20260207_103434_grid`

- Base config: `runs/sweep_20260207_103434_grid/base_config.json`

- Group summary (aggregated): `doc/results_20260207_soc_smoke_soft/group_summary.csv`

- Figures: `doc/results_20260207_soc_smoke_soft/figs`
...
| 1.1 | 0.4 | 0.2465 | 0.6 | 3.5552 | 0.4 | 0.5274 | 0.4 | 199.0000 | 0.6 | 24.5000 |
...
| 1.1 | -0.773 | 0.200 | 0.992 | 0.000 | 0.967 | 0.000 | -0.867 | 0.200 |
